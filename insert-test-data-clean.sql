...
('1:32', 32, 1), ('1:32', 32, 1), ('1:32', 32, 1),
('1:32', 32, 2), ('1:32', 32, 2), ('1:16', 16, 2),
('1:16', 16, 3), ('1:32', 32, 3),
('1:32', 32, 4), ('1:32', 32, 4),
('1:32', 32, 5),
('1:32', 32, 6), ('1:32', 32, 6),
...
(1, 2, 95.0, 'MONOMODE', 'OK'),
(1, 3, 240.0, 'MONOMODE', 'OK'),
(1, 4, 515.0, 'MONOMODE', 'MAINTENANCE'),
(1, 5, 660.0, 'MONOMODE', 'OK'),
(2, 3, 340.0, 'MONOMODE', 'OK'),
(2, 4, 420.0, 'MONOMODE', 'OK');
...
INSERT INTO offre (nom, description, debit_montant, debit_descendant, prix_ht, taux_tva, type_engagement, duree_mois, technologie, actif, created_at, updated_at) VALUES
('Fibre 100', 'Internet FTTH 100 Mbps', 100, 100, 99.99, 20.00, 'SANS_ENGAGEMENT', 1, 'FTTH', TRUE, NOW(), NOW()),
('Fibre 300', 'Internet FTTH 300 Mbps', 300, 300, 149.99, 20.00, 'DOUZE_MOIS', 12, 'FTTH', TRUE, NOW(), NOW()),
('Fibre 500', 'Internet FTTH 500 Mbps', 500, 500, 199.99, 20.00, 'DOUZE_MOIS', 12, 'FTTH', TRUE, NOW(), NOW()),
('Fibre 1000', 'Internet FTTH 1000 Mbps', 1000, 1000, 299.99, 20.00, 'VINGT_QUATRE_MOIS', 24, 'FTTH', TRUE, NOW(), NOW()),
('Fibre Pro 300', 'Internet FTTB 300 Mbps Pro', 300, 300, 129.99, 20.00, 'DOUZE_MOIS', 12, 'FTTB', TRUE, NOW(), NOW());
...
INSERT INTO abonnement (client_id, offre_id, date_debut, date_fin, statut, created_at, version) VALUES
(6, 1, '2026-01-15', '2026-02-15', 'ACTIF', NOW(), 0),
(6, 2, '2026-03-01', '2027-03-01', 'ACTIF', NOW(), 0),
(7, 3, '2025-12-01', '2026-12-01', 'ACTIF', NOW(), 0),
(7, 4, '2026-06-01', '2028-06-01', 'SUSPENDU', NOW(), 0);
...
INSERT INTO facture (abonnement_id, client_id, periode_debut, periode_fin, montant_ht, taux_tva, montant_ttc, statut, date_emission, date_echeance, reference, version) VALUES
(1, 6, '2026-01-15', '2026-02-15', 99.99, 20.00, 119.99, 'PAYEE', '2026-01-14', '2026-02-14', 'FAC-2026-0001', 0),
(1, 6, '2026-02-15', '2026-03-15', 99.99, 20.00, 119.99, 'PAYEE', '2026-02-14', '2026-03-16', 'FAC-2026-0002', 0),
(2, 6, '2026-03-01', '2026-04-01', 149.99, 20.00, 179.99, 'EN_ATTENTE', '2026-03-01', '2026-04-01', 'FAC-2026-0003', 0),
(3, 7, '2025-12-01', '2026-01-01', 199.99, 20.00, 239.99, 'EN_RETARD', '2025-12-01', '2026-01-01', 'FAC-2025-0001', 0),
(3, 7, '2026-01-01', '2026-02-01', 199.99, 20.00, 239.99, 'PAYEE', '2026-01-01', '2026-02-01', 'FAC-2026-0004', 0),
(4, 7, '2026-06-01', '2026-07-01', 299.99, 20.00, 359.99, 'EN_ATTENTE', '2026-06-01', '2026-07-01', 'FAC-2026-0005', 0);

-- ============================================================================
-- 12. DEMANDES DE RACCORDEMENT
-- ============================================================================

DELETE FROM demande_raccordement;

INSERT INTO demande_raccordement (client_created_id, prospect_nom, prospect_prenom, prospect_email, prospect_telephone, adresse_raccordement, offre_id_choisie, statut, created_at) VALUES
(6, 'Petit', 'Luc', 'client1@example.com', '+212612345671', '111 Rue Client, Agadir 80000', 1, 'SOUMISE', NOW(6)),
(7, 'Durand', 'Marie', 'client2@example.com', '+212698765433', '222 Avenue Client, Meknès 50000', 2, 'SOUMISE', NOW(6));
...
INSERT INTO ticket (client_id, agent_id, titre, description, categorie, priorite, statut, escalation_level, created_at, last_activity_at, sla_deadline, closed_at, version) VALUES
...
(7, 2, 'Facturation - Double paiement', 'J''ai été facturisé deux fois en juin', 'FACTURATION', 'MOYENNE', 'RESOLU', 0, NOW(6), NOW(6), DATE_ADD(NOW(), INTERVAL 48 HOUR), DATE_ADD(NOW(), INTERVAL -1 DAY), 0);
...
INSERT INTO notification (destinataire, sujet, contenu, event_type, type_canal, statut, retry_count, created_at, updated_at, version) VALUES
('client1@example.com', 'Bienvenue chez FibreOps', 'Votre abonnement Fibre 100 a été activé', 'ABONNEMENT_ACTIVE', 'EMAIL', 'ENVOYE', 0, NOW(6), NOW(6), 0),
('client2@example.com', 'Nouvelle facturation', 'Votre facture de juin est disponible', 'FACTURE_EMISE', 'EMAIL', 'EN_ATTENTE', 0, NOW(6), NOW(6), 0),
('admin@example.com', 'Alerte: Incident réseau', 'Liaison DC-Rabat en incident depuis 2h', 'INCIDENT_DETETE', 'EMAIL', 'ENVOYE', 0, NOW(6), NOW(6), 0);
...
-- Email: tech1@example.com | Password: test123
-- Email: client1@example.com | Password: test123
-- Email: client2@example.com | Password: test123
