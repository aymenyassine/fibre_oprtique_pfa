...
@Data
public class BoiteClientRequest {
    ...
    @Min(value = 0, message = "Le nombre de ports utilisés ne peut pas être négatif")
    ...
    @NotNull(message = "L'identifiant du splitter est obligatoire")
