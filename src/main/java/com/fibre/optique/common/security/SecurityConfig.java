package com.fibre.optique.common.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/requests").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow Authorization header (JWT) + Content-Type
        config.setAllowedHeaders(List.of("Authorization", "Content-Type", "Accept", "X-Requested-With"));

        // Expose Authorization in response so Axios/fetch can read it if needed
        config.setExposedHeaders(List.of("Authorization"));

        // Allow cookies/credentials if needed in the future
